    ...
    return (
      <div className="flex justify-center items-center">
        <div className="group h-[500px] hover:shadow-xl rounded-md w-full relative overflow-hidden cursor-pointer">
          ...
          <div className="absolute translate-y-[80%] inset-0 group-hover:translate-y-0 flex flex-col items-center transition-all duration-500 justify-center  text-center">
            <h1 className="text-3xl px-3 group-hover:mt-44 finura font-bold text-white">
              {name}
            </h1>
            <div className="text-white w-full h-full opacity-0 flex justify-end flex-col group-hover:opacity-100">
